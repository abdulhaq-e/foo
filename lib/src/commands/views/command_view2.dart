...
import 'package:foo/commands.dart';
...
class CommandView2<Command, Response, Error, ValidationError>
  ...
  final Widget Function(
          BuildContext, CommandState<Command, Response, Error, ValidationError>)
      childBuilder;
  ...
  CommandView2({
    ...
    String? confirmationDialogContent,
        ...
        _confirmationDialogContent = confirmationDialogContent ??
            "Do you want to process the operation?";
