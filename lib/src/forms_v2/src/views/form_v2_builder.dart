...
class FooFormV2WidgetsBuilder<FormData, Form extends HasFormV2Group> {
  ...
  Widget _defaultInitialBuilder(
      BuildContext context, FooFormV2Initial<FormData, Form> state) {
    return Container();
  }

  Widget _defaultLoadingBuilder(
      BuildContext context, FooFormV2Loading<FormData, Form> state) {
    return CircularProgressIndicator();
  }

  Widget _defaultFailedLoadingBuilder(
      BuildContext context, FooFormV2FailedLoading<FormData, Form> state) {
